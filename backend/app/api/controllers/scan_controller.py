...
from ...normalization import CanonicalVulnerability, ResultNormalizer
...
class ScanController:
    ...
    async def run_scan_pipeline(self, scan_id: str, target: str, requested_tools: Iterable[str] | None) -> None:
        ...
        # NOTE: The current implementation does not expose raw `ToolExecutionResult`
        # objects to the controller. The normalizer is wired here for future use
        # when such artifacts are available.
